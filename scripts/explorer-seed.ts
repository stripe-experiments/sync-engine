 ...
 *   STRIPE_API_VERSION=2023-10-16 SEED=1337 bun run scripts/explorer-seed.ts
 */
...
function printUsage(): void {
  console.log('Usage: bun run scripts/explorer-seed.ts --api-version=2020-08-27 --seed=42')
  console.log('')
  console.log('Flags:')
  console.log(
