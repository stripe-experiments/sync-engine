...
for tgz in "$PROTOCOL_TGZ" "$OPENAPI_TGZ" "$ENGINE_TGZ" "$SOURCE_TGZ" "$SOURCE_METRONOME_TGZ" \
           "$DEST_TGZ" "$DEST_SHEETS_TGZ" "$DEST_REDIS_TGZ" "$STATE_PG_TGZ" "$UTIL_PG_TGZ" \
...
pnpm add "$PROTOCOL_TGZ" "$OPENAPI_TGZ" "$ENGINE_TGZ" "$SOURCE_TGZ" "$SOURCE_METRONOME_TGZ" \
         "$DEST_TGZ" "$DEST_SHEETS_TGZ" "$DEST_REDIS_TGZ" "$STATE_PG_TGZ" "$UTIL_PG_TGZ" \
