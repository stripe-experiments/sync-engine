...
function inferGroupName(streamName: string): string {
  ...
  const REFINEMENTS: Record<string, string> = {
    ...
    invoice: 'Billing', invoices: 'Billing',
    credit: 'Billing',
    price: 'Billing', prices: 'Billing',
    plan: 'Billing', plans: 'Billing',
    coupon: 'Billing', coupons: 'Billing',
    payment: 'Payments',
    charge: 'Payments', charges: 'Payments',
    refund: 'Payments', refunds: 'Payments',
    dispute: 'Payments', disputes: 'Payments',
    setup: 'Payments',
    checkout: 'Checkout',
    ...
    payout: 'Payments', payouts: 'Payments',
    balance: 'Transfers',
    application: 'Connect',
    account: 'Connect', accounts: 'Connect',
    issuing: 'Issuing',
    treasury: 'Treasury',
    radar: 'Radar',
    early: 'Radar',
